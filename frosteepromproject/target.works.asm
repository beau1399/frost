...
writeit:
 ...
 FAR_CALL writeit ,kpush


 movlw .2 

   
 FAR_CALL writeit ,safepush
 ...
 movwf EECON1
	...
	movlw	0AAh
	movwf	EECON2
	bsf	EECON1,WR 	;THIS IS WHAT MADE IT WORK
